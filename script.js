...
const sounds = {
  ...
  moveBlock: new Audio('./audio/move_piece.wav'),
  blockRotate: new Audio('./audio/rotate_piece.wav'),
  blockLanded: new Audio('./audio/piece_landed.wav'),
  tetris: new Audio('./audio/tetris_4_lines.wav'),
  clearLine: new Audio('./audio/line_clear.wav')
};
...
function clearLine() {
  ...
  else if (linesCleared > 0) sounds.clearLine.play();
